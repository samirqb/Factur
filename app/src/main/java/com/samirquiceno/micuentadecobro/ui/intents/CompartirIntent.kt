package com.samirquiceno.micuentadecobro.ui.intents
...
fun sharePdfFileIntent(context: Context, pdfFileUri: Uri?){
    ...
    val pdfUri = FileProvider.getUriForFile(context, "com.samirquiceno.micuentadecobro.fileprovider", pdfFile)
